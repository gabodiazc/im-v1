...
typedef struct _S2SessionCmd0 S2SessionCmd0;
typedef struct _S2SessionResp0 S2SessionResp0;
typedef struct _S2SessionCmd1 S2SessionCmd1;
typedef struct _S2SessionResp1 S2SessionResp1;
typedef struct _Sec2Payload Sec2Payload;
...
typedef enum {
  ...
  SEC2_PAYLOAD__PAYLOAD_SR1 = 23
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(SEC2_PAYLOAD__PAYLOAD)
