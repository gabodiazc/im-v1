...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[sec0__pb2.DESCRIPTOR,sec1__pb2.DESCRIPTOR,sec2__pb2.DESCRIPTOR,])
...
_SECSCHEMEVERSION = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SecScheme2', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_SESSIONDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sec2', full_name='SessionData.sec2', index=3,
...
_SESSIONDATA.fields_by_name['sec2'].message_type = sec2__pb2._SEC2PAYLOAD
...
_SESSIONDATA.oneofs_by_name['proto'].fields.append(
  _SESSIONDATA.fields_by_name['sec2'])
_SESSIONDATA.fields_by_name['sec2'].containing_oneof = _SESSIONDATA.oneofs_by_name['proto']
